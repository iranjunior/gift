...
const typeMap: any = {
  ...
  FarmeBox: o([{ json: 'title', js: 'title', typ: '' }], false),
  HomeInitial: o(
  ...
  First: o([{ json: 'text', js: 'text', typ: '' }], false),
  Declaration: o(
    [
      { json: 'title', js: 'title', typ: '' },
  ...
  WhoWeAreInitial: o(
    [{ json: 'who-we-are', js: 'who-we-are', typ: r('FarmeBox') }],
    false
  ),
  OurPeople: o(
    [
  ...
  Menu: o(
    [
      ...
      {
        json: 'button-request-quote',
        js: 'button-request-quote',
        typ: r('ButtonRequestQuote'),
      },
    ],
    false
  ),
  ...
  ButtonRequestQuote: o([{ json: 'label', js: 'label', typ: '' }], false),
  Nav: o(
    [
